...
namespace IceCream.Controllers
{
    public class CustomerModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerId,FirstName,LastName,Birthday,Email")] CustomerModel customerModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerId,FirstName,LastName,Birthday,Email")] CustomerModel customerModel)
        {
            if (ModelState.IsValid)
            {
